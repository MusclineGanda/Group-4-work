...
total_infected_humans <- sum(out$Ih)
period_prevalence<-(total_infected_humans/15000)*100
cat("Period Prevalence after 365 days:", period_prevalence, "%\n")
##Period prevalence
# Period Prevalence after 365 days: 19873.45 %
# its ridiculously high because we are summing all the infected human beings
...
final_infected_humans_with_treatment <- out_with_treatment$Ih[366]  # Number of infected humans at the end after treatment
...
#infections_averted_bytreatment = out$Ih[366] - out_with_treatment$Ih[366]
...
##   Number of cases averted after treatment: 8877.296        ##########
...
final_infected_humans_with_both <- out_with_treatment_vector$Ih[366]  # Number of infected humans at the end after treatment
prevalence_after_both<-(final_infected_humans_with_treatment/15000)*100
cat("Prevalence after 365 days:", prevalence_after_both, "%\n")

#Number of cases averted by treatment
infections_averted_byboth = out$Ih[366] - out_with_treatment_vector$Ih[366]
cat("Number of cases averted after treatment:",infections_averted_byboth)
